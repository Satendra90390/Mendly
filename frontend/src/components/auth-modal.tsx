      ...
      >
        ...
        >
          ...
          <div className="relative z-10 text-center px-6">
            ...
            <p className="text-sm leading-relaxed mb-6" style={{ color: "rgba(148, 163, 184, 0.6)" }}>
        ...
        <div className="flex-1 flex flex-col relative overflow-y-auto">
          ...
          <div className="flex-1 flex flex-col justify-center px-8 sm:px-10 py-8">
            ...
            <div className="mb-6">
              <h1 className="text-2xl font-bold mb-1.5" style={{ color: "#F1F5F9" }}>
            ...
            <form key={mode} onSubmit={handleSubmit} className="space-y-4">
              {mode === "signup" && (
                <div style={{ animation: "fade-in 0.3s ease" }}>
                  <label className="block text-sm font-medium mb-1.5" style={{ color: "rgba(148, 163, 184, 0.7)" }}>Full name</label>
              ...
              <div>
                <label className="block text-sm font-medium mb-1.5" style={{ color: "rgba(148, 163, 184, 0.7)" }}>Email address</label>
                <div className="relative">
                  <span className="absolute left-3.5 top-1/2 -translate-y-1/2" style={{ color: "rgba(148, 163, 184, 0.3)" }}>
              ...
              <div>
                <label className="block text-sm font-medium mb-1.5" style={{ color: "rgba(148, 163, 184, 0.7)" }}>Password</label>
                <div className="relative">
                  <span className="absolute left-3.5 top-1/2 -translate-y-1/2" style={{ color: "rgba(148, 163, 184, 0.3)" }}>
              ...
              <button
                ...
                className="w-full py-3.5 rounded-xl font-semibold text-sm text-white transition-all duration-200 disabled:opacity-50"
                style={{
            ...
            <div className="relative my-5">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="px-4" style={{ backgroundColor: "rgba(15, 23, 42, 0.98)", color: "rgba(148, 163, 184, 0.4)" }}>or continue with</span>
              </div>
            </div>

            <button
              onClick={handleGoogleLogin}
              className="w-full py-3.5 rounded-xl font-medium text-sm flex items-center justify-center gap-3 transition-all duration-200 border hover:bg-white/[0.06]"
              style={{
