...
const TABS = [
  ...
  { label: "Elix", href: "/elix", icon: "M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 014.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19 14.5" },
  ...
  { label: "Nearby", href: "/nearby", icon: "M15 10.5a3 3 0 11-6 0 3 3 0 016 0z M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" },
  { label: "More", href: "/more", icon: "M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" },
];
